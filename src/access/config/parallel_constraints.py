...
class MaxWastedCoreFractionConstraint(LocalConstraint):
    ...
    def is_satisfied(self, layout: ComponentLayout) -> bool:
        ...
        # Quotient form on purpose: comparing against `max_fraction * n_cores` rounds the
        # wrong way at the boundary (0.29 * 100 == 28.999999999999996), whereas
        # idle / n_cores rounds to the same double as the fraction it is compared against.
